...
//               // ✅ Equal width for all items (NO overflow)
//               return Expanded(
//                 child: _NavBarItem(
//                   item: item,
//                   isActive: isActive,
...
//                 // ✅ Text only when active (No overflow)
//                 if (widget.isActive)
//                   Flexible(
//                     child: Padding(
//                       padding:
...
//   static const _pages = [
//     HomeScreen(),
//     MenuScreen(hostelId: '69c614eda370f4b126c482b9',),
//     BookingScreen(),
//     ProfileScreen(),
//   ];
  ...
  Widget build(BuildContext context) {
    ...
    return Consumer<HostelProvider>(
      builder: (context, hostelProvider, _) {
        // Derive hostelId safely — empty string if not yet loaded
        ...
        final qrUrl = hostelProvider.hostels.isNotEmpty
            ? hostelProvider
                  .hostels
                  .first
                  .qrUrl // ← use your actual field name
            : null;

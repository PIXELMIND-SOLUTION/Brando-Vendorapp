...
//       builder: (_) => TransferPopup(tenantName: submission.guest.name),
//     );
//   }
...
//                   disabledBackgroundColor: const Color(0xFFF80500),
//                   foregroundColor: Colors.white,
//                   shape: RoundedRectangleBorder(
//                     borderRadius: BorderRadius.circular(10),
//                   ),
...
//           color: selected ? const Color(0xFFF80500) : const Color(0xFFF5F5F5),
//           borderRadius: BorderRadius.circular(10),
//           border: Border.all(
//             color: selected ? const Color(0xFFF80500) : const Color(0xFFDDDDDD),
//           ),
//         ),
...
//     _joiningDateCtrl = TextEditingController(text: _formatDate(s.joiningDate));
...
//             const SizedBox(height: 12),
//             _EditField(controller: _joiningDateCtrl, hint: 'Joining Date'),
//             const SizedBox(height: 12),
